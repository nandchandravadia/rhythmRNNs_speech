...
class ArabicSpokenDigitsDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return audio[0].unsqueeze(0), label
...
def get_data(data_dir, bs_train, bs_test, device, data_params):
    ...
    train_set = ArabicSpokenDigitsDataset(data_dir + "train.csv")
    test_set = ArabicSpokenDigitsDataset(data_dir + "test.csv")
